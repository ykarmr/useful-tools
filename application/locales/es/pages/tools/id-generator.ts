...
export const idGeneratorEs: IdGeneratorTranslations = {
  ...
  howToUse: {
    title: "Cómo Usar",
    steps: [
      "Selecciona el tipo de ID que quieres generar (UUID, ULID, GUID)",
      "Para UUID, puedes elegir la versión (v1, v4, v6, v7)",
      "Ingresa el número de IDs a generar (1-100)",
      "Configura el formato de visualización (mayúsculas, guiones)",
      "Haz clic en el botón 'Generar' para crear IDs",
      "Copia los IDs generados individualmente o todos a la vez",
    ],
  },
  ...
  features: {
    ...
    items: [
      "Admite generación de UUID v1/v4/v6/v7",
      "Generación de ULID (ordenable cronológicamente)",
      "Generación de GUID (formato Microsoft)",
      "Genera hasta 100 IDs a la vez",
      "Alternar entre mayúsculas y minúsculas",
      "Elegir si incluir guiones",
      "Funcionalidad de copia con un clic",
    ],
  },
