...
export const idGeneratorEn: IdGeneratorTranslations = {
  ...
  howToUse: {
    title: "How to Use",
    steps: [
      "Select the type of ID you want to generate (UUID, ULID, GUID)",
      "For UUID, you can choose the version (v1, v4, v6, v7)",
      "Enter the number of IDs to generate (1-100)",
      "Configure display format (uppercase, hyphens)",
      "Click the 'Generate' button to create IDs",
      "Copy generated IDs individually or all at once",
    ],
  },
  ...
  features: {
    title: "Key Features",
    items: [
      "Supports UUID v1/v4/v6/v7 generation",
      "ULID generation (chronologically sortable)",
      "GUID generation (Microsoft format)",
